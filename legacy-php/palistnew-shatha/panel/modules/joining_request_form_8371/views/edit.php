...
if(!privilege('joining_request_form_8371','edit') || $_form_resp==0 || $_form_resp==1)echo $noPermission;else{?>
...
$_form_sub_resp=db('users_8400',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
                 ...
                 <option value="0" <?=(0==$_form_resp[0]['user']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='username';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['user'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
<div class="input_area">
<div class="check_box_wrap nos"><div class="par"><div class="ch"><input <?=($_form_resp[0]['submitted']==1 ? ' checked ':'');?>
 class=" css-checkbox" name="submitted" type="checkbox" id="<?=$rand='a'.rand(); ?>"/>
...
<div class="input_area">
<input id="for_field_email_address"  required type="email" name="email_address"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['email_address']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_confirm_email_address"  required type="email" name="confirm_email_address"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['confirm_email_address']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_full_name"  required type="text" name="full_name"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['full_name']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_full_name_en"  required type="text" name="full_name_en"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['full_name_en']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_id_number"  required type="number" name="id_number"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['id_number']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_mobile_number"  required type="number" name="mobile_number"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['mobile_number']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_palce_of_birth"  required type="text" name="palce_of_birth"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['palce_of_birth']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_date_of_birth"  required type="date" name="date_of_birth"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['date_of_birth']) ?>"/>
</div>
</div><!--
...
$_form_sub_resp=db('social_situation_8368',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
			else if($_form_sub_resp==1){?><option value="0" selected><?=l('Choose<>اختر');?></option><?php } 
				 else { ?>
                 <option value="" <?=(0==$_form_resp[0]['social_situation']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='title';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['social_situation'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
$_form_sub_resp=db('provinces_8371',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
                 ...
                 <option value="" <?=(0==$_form_resp[0]['province_residence']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='title';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['province_residence'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
<div class="input_area">
<input id="for_field_governorate_abroad"  type="text" name="governorate_abroad"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['governorate_abroad']) ?>"/>
</div>
</div><!--
...
$_form_sub_resp=db('provinces_8371',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
                 ...
                 <option value="" <?=(0==$_form_resp[0]['mother_province']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='title';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['mother_province'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
<div class="input_area">
<input id="for_field_home_adress"  required type="text" name="home_adress"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['home_adress']) ?>"/>
</div>
</div><!--
...
$_form_sub_resp=db('branch_8371',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
			else if($_form_sub_resp==1){?><option value="0" selected><?=l('Choose<>اختر');?></option><?php } 
				 else { ?>
                 <option value="" <?=(0==$_form_resp[0]['branch']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='title';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['branch'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
<div class="input_area">
<input id="for_field_average"  required type="number" name="average"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['average']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<input id="for_field_graduation_year"  required type="number" name="graduation_year"   data-legion-module="joining_request_form_8371" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['graduation_year']) ?>"/>
</div>
</div><!--
...
$_form_sub_resp=db('high_school_country_8371',"WHERE deleted=0    $addition_where",NULL,NULL);
			if($_form_sub_resp==0){?><option value="0" selected><?=l('Error<>خطأ')?></option><?php } 
			else if($_form_sub_resp==1){?><option value="0" selected><?=l('Choose<>اختر');?></option><?php } 
				 else { ?>
                 <option value="" <?=(0==$_form_resp[0]['country']?'selected':'')?>><?=l('Choose<>اختر');?></option>
				<?php
					$echoFields='title';
					$x=explode(',',$echoFields);
					if($_form_sub_resp!=1){
						for($j=0;$j<count($_form_sub_resp);$j++){?>
						<option <?=($_form_sub_resp[$j]['id']==$_form_resp[0]['country'] ? 'selected' : ''); ?> class="main_color_bg whiteFont" value="<?=$_form_sub_resp[$j]['id']?>"><?php 
							for($e=0;$e<count($x);$e++){
								if($x[$e]=='-')echo ' -';
								else {
									if($e!=0)echo ' ';
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['all_attested']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['all_attested']!=NULL){$tmp=fa($_form_resp[0]['all_attested']);
if(is_array($tmp)){
...
<?php } } } ?>
	...
	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['all_attested']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('all_attested','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['proof_passport']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['proof_passport']!=NULL){
			?>
		<div class="fileName"><a target="_blank" href="<?=u.$_form_resp[0]['proof_passport'];?>"><?=$_form_resp[0]['proof_passport'];?></a></div>
<?php } ?>

</div></div>

	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['proof_passport']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('proof_passport','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['high_attested']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['high_attested']!=NULL){
			?>
		<div class="fileName"><a target="_blank" href="<?=u.$_form_resp[0]['high_attested'];?>"><?=$_form_resp[0]['high_attested'];?></a></div>
<?php } ?>

</div></div>

	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['high_attested']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('high_attested','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['certificate_conduct']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['certificate_conduct']!=NULL){
			?>
		<div class="fileName"><a target="_blank" href="<?=u.$_form_resp[0]['certificate_conduct'];?>"><?=$_form_resp[0]['certificate_conduct'];?></a></div>
<?php } ?>

</div></div>

	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['certificate_conduct']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('certificate_conduct','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['work_proof']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['work_proof']!=NULL){
			?>
		<div class="fileName"><a target="_blank" href="<?=u.$_form_resp[0]['work_proof'];?>"><?=$_form_resp[0]['work_proof'];?></a></div>
<?php } ?>

</div></div>

	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['work_proof']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('work_proof','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<img class="po" onclick="browseFile(this)" src="<?=($_form_resp[0]['bank_receipt']==""?u.'file.png':u.'filepicked.png')?>"/>
...
<div><label></label><div class="in " id="<?=$rand_id?>">
	...
	<?php
		if($_form_resp[0]['bank_receipt']!=NULL){
			?>
		<div class="fileName"><a target="_blank" href="<?=u.$_form_resp[0]['bank_receipt'];?>"><?=$_form_resp[0]['bank_receipt'];?></a></div>
<?php } ?>

</div></div>

	<label></label><div id="clear-input_<?=$rand_id?>" class="<?=($_form_resp[0]['bank_receipt']==NULL ? 'hidden':'in')?> clearFiles po" onClick="clearFiles('bank_receipt','<?=$rand_id?>')"><i class="md-light">delete</i></div>
...
<div class="input_area">
<div class="check_box_wrap nos"><div class="par"><div class="ch"><input required <?=($_form_resp[0]['confirm_that']==1 ? ' checked ':'');?>
 class=" css-checkbox" name="confirm_that" type="checkbox" id="<?=$rand='a'.rand(); ?>"/>
