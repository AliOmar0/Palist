<?php if(!privilege('employment_status_8368','add'))echo $noPermission;else{?>
...
<input id="for_field_title"  type="text"  data-legion-module="employment_status_8368" name="title" placeholder="" value=""/>
</div>
</div><!--
