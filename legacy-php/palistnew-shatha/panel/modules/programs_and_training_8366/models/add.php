...
//add to database
try{
	mysqli_query($conn,"INSERT INTO $_module (photo,title,content,publish_date,admin_add_id,date_created) VALUES ('$photo','$title','$content','$publish_date','$admin_add_id','$date_created')");
}
