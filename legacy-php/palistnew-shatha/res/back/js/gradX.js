...
//p(_options);
    ...
    gradx = {
        ...
        load_gradx: function(id, sliders,custom_function='',custom_var='') {
            this.me = gradx.gx(id);
            this.id = id.replace("#", "");
            id = this.id;
            this.current_slider_id = false;
            var html = "<div class='gradx'>\n\
                        <div id='gradx_add_slider' class='gradx_add_slider gradx_btn'><i>add</i></div>\n\
<div id='gradx_done_slider' class='gradx_add_slider gradx_btn' onclick='"+custom_function+"(this,"+custom_var+")'><i>check_circle_outline</i></div>\n\
<div id='gradx_close_slider' class='gradx_add_slider gradx_btn' onclick='gradxClose()'><i>close</i></div>\n\
                        <div class='gradx_slectboxes'>\n\
                        <select id='gradx_gradient_type' class='gradx_gradient_type in noSelect2'>\n\
                            <option value='linear'>Linear</option>\n\
                            <option value='circle'>Radial - Circle</option>\n\
                            <option value='ellipse'>Radial - Ellipse</option>\n\
                        </select>\n\
                        <select id='gradx_gradient_subtype' class='gradx_gradient_type in noSelect2'>\n\
                        ...
                        <select id='gradx_gradient_subtype2' class='gradx_gradient_type gradx_hide noSelect2'>\n\
                        </select>\n\
                        <select id='gradx_radial_gradient_size' class='gradx_gradient_type gradx_hide noSelect2'>\n\
                        </select>\n\
                        </div>\n\
                            ...
                            <div class='gradx_start_sliders' id='gradx_start_sliders_" + id + "'>\n\
                                <div class='cp-default' id='gradx_slider_info'>\n\
                                    <div id='gradx_slider_controls'>\n\
                                        <div id='gradx_delete_slider' class='gradx_btn'><i>delete</i></div>\n\
                                    </div>\n\
                                    <div id='gradx_slider_content'></div>\n\
                                </div> \n\
                            </div>\n\
                        </div>\n\
                        <div id='gradx_show_code' class='gradx_show_code gradx_btn'><i>code</i></div>\n\
                        <div id='gradx_show_presets' style='display:none' class='gradx_show_presets gradx_btn'><i>source</i><span>presets</span></div>\n\
...
//            if(!gradx.jQ_present){
    ...
    gradx.load_gradx(id, gradx.sliders,gradx.custom_function,gradx.custom_var);
