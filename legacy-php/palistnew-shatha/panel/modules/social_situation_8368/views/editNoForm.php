...
if(!privilege('social_situation_8368','edit') || $_form_resp==0 || $_form_resp==1)echo $noPermission;else{?>
...
<input id="for_field_title"  type="text" name="title"   data-legion-module="social_situation_8368" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['title']) ?>"/>
</div>
</div><!--
