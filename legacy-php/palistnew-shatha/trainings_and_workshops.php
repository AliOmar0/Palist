...
<div id="">
<?php $_m='trainings_and_workshops_8419';?>
<section id="trainings_and_workshops_wrap" class="major_section w1200">
<div class="line_box">
...
<!--    <?php 
    ...
    if($resp==1) echo '<div class="no_data">'.l('No Data<>لا مُدخلات').'</div>';
            ...
            // echo $resp[$i]['id'];
            // echo "               ";
                ?> --><a class="trainings_and_workshops_box in" title="<?=l($resp[$i]['title']) ?>" href="<?=url($_m,'single',$resp[$i]['id'])?>">
                <?php pic($resp[$i]['photo'],400,100,l($resp[$i]['title']),true,NULL,'trainings_and_workshops_photo_picture');?>
                <div class="program_cont training_cont">
                    <h2 class="trainings_and_workshops_title"><?=l($resp[$i]['title']);?></h2>
                    <p class="trainings_and_workshops_content"><?=l($resp[$i]['summary']);?></p>
