...
if(!privilege('advertisements_8362','edit') || $_form_resp==0 || $_form_resp==1)echo $noPermission;else{
...
<input id="for_field_title"  type="text" name="title"   data-legion-module="advertisements_8362" placeholder="" value="<?=htmlspecialchars($_form_resp[0]['title']) ?>"/>
</div>
</div><!--
...
<div class="input_area">
<div class="po pvp_chooser" data-filetype="photo" data-multi="false" onclick="pvp_core('advertisements_8362_photo',false,false)"><img src="<?=u.($_form_resp[0]['photo']=='' ? 'photo.png' : img($_form_resp[0]['photo'],200,100));  ?>" /></div>
	<div class="in clearFiles po <?=$_form_resp[0]['photo']=='' ? 'hidden':'' ?>" onclick="pvp_clear('advertisements_8362_photo')"><i class="md-light">delete</i></div>
